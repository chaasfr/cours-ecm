    ...
    <div class="container">
        ...
        <form class="form-inline">
            <div class="form-group">
                ...
                <input type="text" data-role="tags" data-service-url="/tags.json" data-limit="1" class="form-control" id="tag" placeholder="Tag" name="tag" value="${fn:escapeXml(searchForm.tag)}" style="width: 200px;">
            </div>
